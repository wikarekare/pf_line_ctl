...
for i in 1 2 3 4 5 6; do
  scp -i /home/wikk/.ssh/id_rsa  ${TMP_DIR}/table_line_${i}.srt wikk@admin2:${WWW_DIR}/line${i}.txt
  scp -i /home/wikk/.ssh/id_rsa  ${TMP_DIR}/table_line_state_${i} wikk@admin2:${WWW_DIR}/line${i}_state.txt
done

#Should be the other way around, and driven from the web interface, into the DB.
scp -i /home/wikk/.ssh/id_rsa ${CONF_DIR}/line_state.json ${CONF_DIR}/host_line_map.json wikk@admin2:${CONF_DIR}/
